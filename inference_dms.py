...
def init():
    ...
    val(args, net, dataloader_test)

def val(args, net, dataloader_test,):
...
def write_data(total_emb, p_name, p_len):
    ...
    #else:
    f.create_dataset('embeddings', data=np.array(total_emb, dtype='float32'), compression="gzip", chunks=True, maxshape=(None,1024,33)) 
